(ns com.github.ebaptistella.logic.str.str0006
  "Pure STR0006 logic: field maps and XML serialization for R1, R2 and E responses."
...
(def ^:private field-ordering
  {"STR0006R1" [:CodMsg :NumCtrlIF :ISPBIFDebtd :NumCtrlSTR :SitLancSTR :DtHrSit :DtMovto]
   "STR0006R2" [:CodMsg :ISPBIFDebtd :ISPBIFCredtd :VlrLanc :FinlddCli :NumCtrlSTR :DtHrBC]
   "STR0006E"  [:CodMsg :NumCtrlIF :ISPBIFDebtd :MotivoRejeicao]})
