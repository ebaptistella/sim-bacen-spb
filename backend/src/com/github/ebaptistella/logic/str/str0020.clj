(ns com.github.ebaptistella.logic.str.str0020
  "Pure STR0020 logic: field maps and XML serialization for R1, R2 and E responses."
...
(def ^:private field-ordering
  {:STR0020R1 [:CodMsg :NumCtrlIF :ISPBIFDebtd :NumCtrlSTR :SitLancSTR :DtHrSit :DtMovto]
   :STR0020R2 [:CodMsg :ISPBIFDebtd :ISPBIFCredtd :VlrLanc :FinlddIF :NumCtrlSTR :DtHrBC]
   :STR0020E  [:CodMsg :NumCtrlIF :ISPBIFDebtd :MotivoRejeicao]})
