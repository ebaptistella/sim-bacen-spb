(ns com.github.ebaptistella.logic.str.str0043
  "Pure STR0043 logic: agendamento de teste de contingência Internet. Fluxo1: apenas R1."
  (:require [com.github.ebaptistella.logic.str.xml :as xml]
            [schema.core :as s])
  (:import [java.time Instant]))

(def ^:private field-ordering
  {:STR0043R1 [:CodMsg :NumCtrlIF :ISPBIFDebtd :NumCtrlSTR :SitLancSTR :DtHrSit]})
