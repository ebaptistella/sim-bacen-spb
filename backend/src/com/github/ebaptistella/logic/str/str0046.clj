(ns com.github.ebaptistella.logic.str.str0046
  "Pure STR0046 logic: devolução de repasse de tributos. R2 ecoa NumCtrlSTROr como referência ao original."
...
(def ^:private field-ordering
  {:STR0046R1 [:CodMsg :NumCtrlIF :ISPBIFDebtd :NumCtrlSTR :SitLancSTR :DtHrSit :DtMovto]
   :STR0046R2 [:CodMsg :ISPBIFDebtd :ISPBIFCredtd :VlrLanc :FinlddIF :NumCtrlSTROr :NumCtrlSTR :DtHrBC]
   :STR0046E  [:CodMsg :NumCtrlIF :ISPBIFDebtd :MotivoRejeicao]})
