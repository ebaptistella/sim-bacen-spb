(ns com.github.ebaptistella.logic.str.str0004
  "Pure STR0004 logic: field maps and XML serialization for R1, R2 and E responses."
...
(def ^:private field-ordering
  {:STR0004R1 [:CodMsg :NumCtrlIF :ISPBIFDebtd :NumCtrlSTR :SitLancSTR :DtHrSit :DtMovto]
   :STR0004R2 [:CodMsg :ISPBIFDebtd :ISPBIFCredtd :VlrLanc :FinlddIF :NumCtrlSTR :DtHrBC]
   :STR0004E  [:CodMsg :NumCtrlIF :ISPBIFDebtd :MotivoRejeicao]})
