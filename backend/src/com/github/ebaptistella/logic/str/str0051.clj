(ns com.github.ebaptistella.logic.str.str0051
  "Pure STR0051 logic: field maps and XML serialization for R1, R2 and E responses."
...
(def ^:private field-ordering
  {:STR0051R1 [:CodMsg :NumCtrlIF :ISPBIFDebtd :NumCtrlSTR :SitLancSTR :DtHrSit :DtMovto]
   :STR0051R2 [:CodMsg :ISPBIFDebtd :ISPBIFCredtd :VlrLanc :FinlddCli :NumCtrlSTR :DtHrBC]
   :STR0051E  [:CodMsg :NumCtrlIF :ISPBIFDebtd :MotivoRejeicao]})
