(ns com.github.ebaptistella.logic.str.str0026
  "Pure STR0026 logic: field maps and XML serialization for R1, R2 and E responses."
...
(def ^:private field-ordering
  {:STR0026R1 [:CodMsg :NumCtrlIF :ISPBIFDebtd :NumCtrlSTR :SitLancSTR :DtHrSit :DtMovto]
   :STR0026R2 [:CodMsg :ISPBIFDebtd :ISPBIFCredtd :VlrLanc :FinlddIF :NumCtrlSTR :DtHrBC]
   :STR0026E  [:CodMsg :NumCtrlIF :ISPBIFDebtd :MotivoRejeicao]})
