(ns com.github.ebaptistella.logic.str.str0010
  "Pure STR0010 logic: devolução de TED indevida. R1 (confirmação), R2 (notificação IF-Creditada), E (rejeição)."
...
(def ^:private field-ordering
  {:STR0010R1 [:CodMsg :NumCtrlIF :ISPBIFDebtd :NumCtrlSTR :SitLancSTR :DtHrSit :DtMovto]
   :STR0010R2 [:CodMsg :ISPBIFDebtd :ISPBIFCredtd :VlrLanc :CodDevTransf :NumCtrlSTROr :NumCtrlSTR :DtHrBC]
   :STR0010E  [:CodMsg :NumCtrlIF :ISPBIFDebtd :MotivoRejeicao]})
