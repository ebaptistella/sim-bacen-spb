(ns com.github.ebaptistella.logic.str.str0034
  "Pure STR0034 logic: field maps and XML serialization for R1, R2 and E responses."
...
(def ^:private field-ordering
  {:STR0034R1 [:CodMsg :NumCtrlIF :ISPBIFDebtd :NumCtrlSTR :SitLancSTR :DtHrSit :DtMovto]
   :STR0034R2 [:CodMsg :ISPBIFDebtd :ISPBIFCredtd :VlrLanc :FinlddIF :NumCtrlSTR :DtHrBC]
   :STR0034E  [:CodMsg :NumCtrlIF :ISPBIFDebtd :MotivoRejeicao]})
