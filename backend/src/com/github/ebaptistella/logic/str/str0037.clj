(ns com.github.ebaptistella.logic.str.str0037
  "Pure STR0037 logic: field maps and XML serialization for R1, R2 and E responses."
...
(def ^:private field-ordering
  {:STR0037R1 [:CodMsg :NumCtrlIF :ISPBIFDebtd :NumCtrlSTR :SitLancSTR :DtHrSit :DtMovto]
   :STR0037R2 [:CodMsg :ISPBIFDebtd :ISPBIFCredtd :VlrLanc :FinlddCli :NumCtrlSTR :DtHrBC]
   :STR0037E  [:CodMsg :NumCtrlIF :ISPBIFDebtd :MotivoRejeicao]})
