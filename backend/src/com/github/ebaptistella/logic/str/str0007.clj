(ns com.github.ebaptistella.logic.str.str0007
  "Pure STR0007 logic: field maps and XML serialization for R1, R2 and E responses.
   STR0007 uses FinlddIF (IF-initiated transfer) instead of FinlddCli in R2."
...
(def ^:private field-ordering
  {"STR0007R1" [:CodMsg :NumCtrlIF :ISPBIFDebtd :NumCtrlSTR :SitLancSTR :DtHrSit :DtMovto]
   "STR0007R2" [:CodMsg :ISPBIFDebtd :ISPBIFCredtd :VlrLanc :FinlddIF :NumCtrlSTR :DtHrBC]
   "STR0007E"  [:CodMsg :NumCtrlIF :ISPBIFDebtd :MotivoRejeicao]})
