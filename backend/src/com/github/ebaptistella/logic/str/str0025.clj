(ns com.github.ebaptistella.logic.str.str0025
  "Pure STR0025 logic: field maps and XML serialization for R1, R2 and E responses."
...
(def ^:private field-ordering
  {:STR0025R1 [:CodMsg :NumCtrlIF :ISPBIFDebtd :NumCtrlSTR :SitLancSTR :DtHrSit :DtMovto]
   :STR0025R2 [:CodMsg :ISPBIFDebtd :ISPBIFCredtd :VlrLanc :FinlddCli :NumCtrlSTR :DtHrBC]
   :STR0025E  [:CodMsg :NumCtrlIF :ISPBIFDebtd :MotivoRejeicao]})
