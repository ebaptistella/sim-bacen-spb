(ns com.github.ebaptistella.wire.in.str.str0013
  "Wire-in STR0013: raw XML → domain model for saldo query."
...
(defmethod parse-inbound :STR0013
  [{:keys [queue-name message-id body]}]
  (let [fields (parser/parse-str0013 body)]
