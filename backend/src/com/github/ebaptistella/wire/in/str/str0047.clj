(ns com.github.ebaptistella.wire.in.str.str0047
  "Wire-in STR0047: raw XML → domain model using parse-str0047 (transferência para portabilidade de crédito PF, extracts FinlddIF + TpCtDebtd + TpCtCredtd)."
...
(defmethod parse-inbound :STR0047
  [{:keys [queue-name message-id body]}]
  (let [fields (parser/parse-str0047 body)]
