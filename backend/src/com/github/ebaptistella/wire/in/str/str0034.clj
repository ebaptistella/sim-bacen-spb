(ns com.github.ebaptistella.wire.in.str.str0034
  "Wire-in STR0034: raw XML → domain model using parse-str0034 (TED envolvendo IF sem conta Reservas Bancárias, extracts FinlddIF + TpCtDebtd + TpCtCredtd)."
...
(defmethod parse-inbound :STR0034
  [{:keys [queue-name message-id body]}]
  (let [fields (parser/parse-str0034 body)]
