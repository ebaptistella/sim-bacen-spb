(ns com.github.ebaptistella.wire.in.str.str0029
  "Wire-in STR0029: raw XML → domain model using parse-str0029 (repasse de demais arrecadações)."
...
(defmethod parse-inbound :STR0029
  [{:keys [queue-name message-id body]}]
  (let [fields (parser/parse-str0029 body)]
