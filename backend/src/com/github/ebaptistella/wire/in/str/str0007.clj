(ns com.github.ebaptistella.wire.in.str.str0007
  "Wire-in STR0007: raw XML → domain model using parse-str0007 (extracts FinlddIF)."
...
(defmethod parse-inbound :STR0007
  [{:keys [queue-name message-id body]}]
  (let [fields (parser/parse-str0007 body)]
