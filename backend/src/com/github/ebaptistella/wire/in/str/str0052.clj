(ns com.github.ebaptistella.wire.in.str.str0052
  "Wire-in STR0052: raw XML → domain model using parse-str0052 (transferência para portabilidade Open Finance, extracts FinlddIF + TpCtDebtd + TpCtCredtd)."
...
(defmethod parse-inbound :STR0052
  [{:keys [queue-name message-id body]}]
  (let [fields (parser/parse-str0052 body)]
