(ns com.github.ebaptistella.wire.in.str.str0035
  "Wire-in STR0035: raw XML → domain model for extrato de tarifação query."
...
(defmethod parse-inbound :STR0035
  [{:keys [queue-name message-id body]}]
  (let [fields (parser/parse-str0035 body)]
