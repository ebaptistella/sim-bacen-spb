(ns com.github.ebaptistella.wire.in.str.str0045
  "Wire-in STR0045: raw XML → domain model using parse-str0045 (repasse de tributos para IF centralizadora)."
...
(defmethod parse-inbound :STR0045
  [{:keys [queue-name message-id body]}]
  (let [fields (parser/parse-str0045 body)]
