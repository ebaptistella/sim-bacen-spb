(ns com.github.ebaptistella.wire.in.str.str0020
  "Wire-in STR0020: raw XML → domain model using parse-str0020 (repasse de tributos estaduais)."
...
(defmethod parse-inbound :STR0020
  [{:keys [queue-name message-id body]}]
  (let [fields (parser/parse-str0020 body)]
